# Complete official list of Colombian Departments and All Municipalities/Cities

COLOMBIAN_DEPARTMENTS = [
  {"id": "dep-01", "code": "05", "name": "Antioquia"},
  {"id": "dep-02", "code": "08", "name": "Atlántico"},
  {"id": "dep-03", "code": "11", "name": "Bogotá D.C."},
  {"id": "dep-04", "code": "13", "name": "Bolívar"},
  {"id": "dep-05", "code": "15", "name": "Boyacá"},
  {"id": "dep-06", "code": "17", "name": "Caldas"},
  {"id": "dep-07", "code": "18", "name": "Caquetá"},
  {"id": "dep-08", "code": "19", "name": "Cauca"},
  {"id": "dep-09", "code": "20", "name": "Cesar"},
  {"id": "dep-10", "code": "23", "name": "Córdoba"},
  {"id": "dep-11", "code": "25", "name": "Cundinamarca"},
  {"id": "dep-12", "code": "27", "name": "Chocó"},
  {"id": "dep-13", "code": "41", "name": "Huila"},
  {"id": "dep-14", "code": "44", "name": "La Guajira"},
  {"id": "dep-15", "code": "47", "name": "Magdalena"},
  {"id": "dep-16", "code": "50", "name": "Meta"},
  {"id": "dep-17", "code": "52", "name": "Nariño"},
  {"id": "dep-18", "code": "54", "name": "Norte de Santander"},
  {"id": "dep-19", "code": "63", "name": "Quindío"},
  {"id": "dep-20", "code": "66", "name": "Risaralda"},
  {"id": "dep-21", "code": "68", "name": "Santander"},
  {"id": "dep-22", "code": "70", "name": "Sucre"},
  {"id": "dep-23", "code": "73", "name": "Tolima"},
  {"id": "dep-24", "code": "76", "name": "Valle del Cauca"},
  {"id": "dep-25", "code": "81", "name": "Arauca"},
  {"id": "dep-26", "code": "85", "name": "Casanare"},
  {"id": "dep-27", "code": "86", "name": "Putumayo"},
  {"id": "dep-28", "code": "88", "name": "San Andrés y Providencia"},
  {"id": "dep-29", "code": "91", "name": "Amazonas"},
  {"id": "dep-30", "code": "94", "name": "Guainía"},
  {"id": "dep-31", "code": "95", "name": "Guaviare"},
  {"id": "dep-32", "code": "97", "name": "Vaupés"},
  {"id": "dep-33", "code": "99", "name": "Vichada"},
]

COLOMBIAN_CITIES_BY_DEPT = {
  ...
  "Cundinamarca": [
    ...
    "Cachipay", "Cajicá", "Caparrapí", "Cáqueza", "Carmen de Carupa", "Chaguaní", "Chía", "Chipaque", "Choachí", "Chocontá",
    "Cogua", "Cota", "Cucunubá", "El Colegio", "El Peñón", "El Rosal", "Facatativá", "Fómeque", "Fosca", "Funza",
    "Fúquene", "Fusagasugá", "Gachalá", "Gachancipá", "Gachetá", "Gama", "Girardot", "Granada", "Guachetá", "Guaduas",
    "Guasca", "Guataquí", "Guatavita", "Guayabal de Síquima", "Guayabetal", "Gutiérrez", "Jerusalén", "Junín", "La Calera", "La Mesa",
    "La Palma", "La Peña", "La Vega", "Lenguazaque", "Machetá", "Madrid", "Manta", "Medina", "Mosquera", "Nariño",
    "Nemocón", "Nilo", "Nimaima", "Nocaima", "Venecia", "Pacho", "Paime", "Pandi", "Paratebueno", "Pasca",
    ...
    "Topaipí", "Ubalá", "Ubaque", "Villa de San Diego de Ubaté", "Une", "Útica", "Vergara", "Vianí", "Villagómez", "Villapinzón",
  ...
  "Santander": [
    ...
    "Enciso", "Floridablanca", "Galán", "Gámbita", "Girón", "Guaca", "Guadalupe", "Guapotá", "Guavatá", "Güepsa",
    "Hato", "Jesús María", "Jordán", "Landázuri", "La Belleza", "La Paz", "Lebrija", "Los Santos", "Macaravita", "Málaga",
    "Matanza", "Mogotes", "Molagavita", "Ocamonte", "Oiba", "Onzaga", "Palmar", "Palmas del Socorro", "Pie de Cuesta", "Pinchote",
